...
const ENTRIES: Entry[] = [
  ...
  { date: "Mid 2023", location: "Observatory Moon", type: "moon", doing: "Optimising my own work with AI. Public documents only. No mandate.", insight: "Start safe, start small. Optimise your own practice before making claims about anyone else's." },
  { date: "Q4 2023 – Q1 2024", location: "Binary System", type: "binary", doing: "A/B testing: Human vs. Human augmented with AI — 10 evaluators, ~40 documents.", insight: "'I think AI helps' is an opinion. A controlled comparison is an argument." },
  { date: "Mar 2024", location: "Command Orbit", type: "ringedplanet", doing: "First AI strategy session with senior leadership.", insight: "The comparative study was the entry ticket. Not enthusiasm — data." },
  { date: "Mid 2024", location: "Orbital Station", type: "station", doing: "Building the first internal AI drafting system.", insight: "The work expanded to fill the absence of anyone else doing it. That is how you learn what the actual problems are." },
  { date: "Jan 2025", location: "Open Cluster", type: "cluster", doing: "AI Ambassador network — 30 people. 50% AI mandate.", insight: "What I had built for myself worked — in my hands. That turned out to be nearly irrelevant for everyone else." },
  { date: "Aug 2025", location: "Signal Beacon", type: "beacon", doing: "Mapping every mission phase to the right AI tool. 94 rows. 28 training videos.", insight: "Individual practice has a half-life. The only way to make it last is to make it legible." },
  { date: "Sep 2025", location: "Survey Satellite", type: "satellite", doing: "Large-scale internal survey. 200 people. No real picture before.", insight: "You cannot govern what you have not measured. The move from builder to strategist starts here." },
  ...
  { date: "Jan 2026", location: "Primary Star", type: "sunstar", doing: "Formally appointed to 100% AI.", insight: "The recognition of something that had been true for two years already. Doing → proving → formalising." },
  { date: "Feb – Mar 2026", location: "New World", type: "homeplanet", doing: "Claude Skills is the future of agentic creation for non-technical experts. One per day.", insight: "The answer to the adoption problem was not better tools. It was giving people the means to build their own." },
];
